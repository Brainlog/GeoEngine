...
const backendUrl = 'http://localhost:3001'; // Change to your actual backend URL
...
let split;
  ...
  function initEditor() {
      ...
      if (editorElement) {
          ...
          let mode = editorElement.getAttribute("data-mode") || 'python'
  ...
  document.getElementById("download").addEventListener("click", ()=>{
    var file = new File([editor.getValue()], "zup.py", {type: "text/plain;charset=utf-8"});
    saveAs(file);
  })
  ...
  document.getElementById("run").addEventListener("click", ()=>{
    ...
    axios.post(`${backendUrl}/run`,requestData, {headers: {
